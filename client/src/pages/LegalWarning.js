    ...
    <div className='page legalWarning'>
      ...
      <div
        ...
        <p>
          ...
          <ul>
            <li>• Denominación social: CLINICA VIEITEZ NUÑEZ 2022 SLP.</li>
            <li>• CIF: 	B09901737</li>
            <li>• Domicilio social: C. Romería del Rocío, 4, LOCAL 12, 29640 Fuengirola, Málaga</li>
            <li>• Inscrita en el Registro Mercantil de: Registro Mercantil de Málaga - 2 actos en BORME publicados. CNAE "8623 - Actividades odontológicas"</li>
            <li>• Teléfono: 952001202</li>
            <li>• Email: hola@clinicavn.com</li>
          </ul>
        </p>
        <hr
        ...
        <hr
          class="my-6 h-0.5 border-t-0 bg-neutral-200 opacity-100 dark:opacity-30" />
        <p class="mb-4">
        Leer más acerca del Aviso Legal
        </p>
        <button
          type="button"
          data-te-ripple-init
